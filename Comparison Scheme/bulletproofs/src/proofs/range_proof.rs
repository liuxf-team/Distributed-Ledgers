...
impl RangeProof {
    ...
    pub fn verify(
        ...
        let P = (0..nm)
            ...
            .fold(P1, |acc, x| acc + x);
        let verify = self
        .inner_product_proof.verify(g_vec, &hi_tag, &Gx, &P);
