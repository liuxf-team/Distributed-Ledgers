...
/// 拆分处理各种类型的消息
pub async fn handle_setup_msg(msg : NodeToRegulatorSetupPhaseP2PMsg, msg_vec : &Arc<TokioMutex<Vec<NodeToRegulatorSetupPhaseP2PMsg>>>, msg_num : &Arc<TokioMutex<i32>>) 
{
...
/// 序列化key manage阶段的消息
// pub fn key_manage_to_gstbk (msg_key_manage : gs_tbk_scheme::messages::regulator::common_msg::KeyManageMsg) -> String
// {
//     let msg_str = serde_json::to_string(&gs_tbk_scheme::messages::common_msg::GSTBKMsg::GSTBKMsgP(gs_tbk_scheme::messages::regulator::common_msg::GSTBKMsg::KeyManageMsg(msg_key_manage))).unwrap();
//     return msg_str;
// }
